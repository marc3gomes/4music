...
namespace Blueskytechco\LayeredAjax\Model\ResourceModel\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
	...
	public function getSearchCriteriaBuilder()
	{
		if ($this->searchCriteriaBuilder === null) {
			$this->searchCriteriaBuilder = ObjectManager::getInstance()
				->get('\Blueskytechco\LayeredAjax\Model\Search\SearchCriteriaBuilder');
		}
	...
	public function setSearchCriteriaBuilder(\Blueskytechco\LayeredAjax\Model\Search\SearchCriteriaBuilder $object)
	{
