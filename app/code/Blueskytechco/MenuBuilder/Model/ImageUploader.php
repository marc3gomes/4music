...
class ImageUploader
{
    ...
    public function __construct(
        ...
        $this->logger = $logger;
        $this->baseTmpPath = 'menus/submenu/background';
        $this->basePath = 'menus/submenu/background';
        $this->baseIconPath = 'menus/submenu/icon';
    ...
    public function saveFileIconToTmpDir($fileId)
    {
        $baseTmpPath = $this->baseIconPath();
