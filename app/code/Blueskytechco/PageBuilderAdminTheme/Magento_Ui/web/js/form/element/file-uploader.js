        ...
        onPreviewLoad: function (file, event) {
            ...
            if(file.previewType == "image"){
                if($("input[name='image_width']").length){
                    $("input[name='image_width']").val(img.naturalWidth).trigger("change");
                    $("input[name='image_height']").val(img.naturalHeight).trigger("change");
                }
            }
        },
