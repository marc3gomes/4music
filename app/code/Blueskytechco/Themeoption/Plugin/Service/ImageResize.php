...
namespace Blueskytechco\Themeoption\Plugin\Service;
        ...
        foreach ($themes as $theme) {
            ...
            foreach ($images as $imageId => $imageData) {
                foreach ($stores as $store) {
                    $imageData = $this->_helperProduct->getConfigurationSizeImages($imageId, $imageData, (int) $store->getId());
