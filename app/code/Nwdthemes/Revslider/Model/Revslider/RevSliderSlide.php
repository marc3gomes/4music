...
class RevSliderSlide extends RevSliderFunctions {
	...
	public function exist_by_id($slideid){
        ...
        try{
			if(strpos($slideid, 'static_') !== false){
				...
				$this->validate_numeric($slide_id, __('Slide ID'));
		...
		foreach($img_sizes as $img_handle => $img_name){
			...
			if($featured_image_url !== false){
				$attr['img_urls'][$img_handle] = array(
					...
					'tag' => '<img class="'.$class.'" src="'.$featured_image_url[0].'" width="'.$featured_image_url[1].'" height="'.$featured_image_url[2].'" alt="'.FA::esc_attr($this->get_val($attr, 'title')).'" data-no-retina />'
				);
			}
		}
	...
	public function init_by_stream_data($data, $template, $slider_id, $sourcetype, $additions){
		...
		switch($a['sourcetype']){
			...
			default:
				...
				if($return === false) $this->throw_error(__('Source must be from Stream'));
			break;
		}
		...
		switch($stream_type){
				...
				if($this->get_val($additions, 'fb_type') == 'album'){
					...
					$attr1 = array(
						...
						'img_urls'	=> array(
							'full'	=> array(
								'url' => $fb_img,
                                'tag' => '<img'.$class.' src="'.$fb_img.'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'name')).'" data-no-retina />'
                            ),
							'thumbnail' => array(
								'url' => $fb_img_thumbnail,
                                'tag' => '<img'.$class.' src="'.$fb_img_thumbnail.'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'name')).'" data-no-retina />'
                            )
						)
					);
				}else{
			...
			case 'twitter':
				...
				if($img !== ''){
					...
					$attr1['img_urls'] = array(
						'large' => array(
							'url' => $img,
							'tag' => '<img'.$class.' src="'.$img.'" width="'.$w.'" height="'.$h.'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'full_text')).'" data-no-retina />'
						)
					);
				}
			break;
			case 'instagram':
				...
				if(!empty($inst_img)){
					...
					$attr1['img_urls']['original'] = array(
						'url' => $inst_img,
						'tag' => '<img'.$class.' src="'.$inst_img.'" width="'.$this->get_val($this->post_data, array('dimensions', 'width')).'" height="'.$this->get_val($this->post_data, array('dimensions', 'height')).'" alt="'.FA::esc_attr($this->get_val($attr1, 'title')).'" data-no-retina />'
					);
				...
				if(!empty($inst_thumb)){
					...
					$attr1['img_urls']['thumb'] = array(
						'url' => $inst_thumb,
						'tag' => '<img'.$class.' src="'.$inst_thumb.'" width="'.$this->get_val($this->post_data, array('dimensions', 'width')).'" height="'.$this->get_val($this->post_data, array('dimensions', 'height')).'" alt="'.FA::esc_attr($this->get_val($attr1, 'title')).'" data-no-retina />'
					);
			...
			case 'flickr':
				$attr1 = array(
					...
					'img_urls'	=> array(
						'square' 	 => array('url' => $this->get_val($this->post_data, 'url_sq'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_sq').'" width="'.$this->get_val($this->post_data, 'width_sq').'" height="'.$this->get_val($this->post_data, 'height_sq').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'large-square' => array('url' => $this->get_val($this->post_data, 'url_q'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_q').'" width="'.$this->get_val($this->post_data, 'width_q').'" height="'.$this->get_val($this->post_data, 'height_q').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'thumbnail'  => array('url' => $this->get_val($this->post_data, 'url_t'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_t').'" width="'.$this->get_val($this->post_data, 'width_t').'" height="'.$this->get_val($this->post_data, 'height_t').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'small' 	 => array('url' => $this->get_val($this->post_data, 'url_s'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_s').'" width="'.$this->get_val($this->post_data, 'width_s').'" height="'.$this->get_val($this->post_data, 'height_s').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'small-320'  => array('url' => $this->get_val($this->post_data, 'url_n'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_n').'" width="'.$this->get_val($this->post_data, 'width_n').'" height="'.$this->get_val($this->post_data, 'height_n').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'medium' 	 => array('url' => $this->get_val($this->post_data, 'url_m'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_m').'" width="'.$this->get_val($this->post_data, 'width_m').'" height="'.$this->get_val($this->post_data, 'height_m').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'medium-640' => array('url' => $this->get_val($this->post_data, 'url_z'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_z').'" width="'.$this->get_val($this->post_data, 'width_z').'" height="'.$this->get_val($this->post_data, 'height_z').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'medium-800' => array('url' => $this->get_val($this->post_data, 'url_c'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_c').'" width="'.$this->get_val($this->post_data, 'width_c').'" height="'.$this->get_val($this->post_data, 'height_c').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'large' 	 => array('url' => $this->get_val($this->post_data, 'url_l'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_l').'" width="'.$this->get_val($this->post_data, 'width_l').'" height="'.$this->get_val($this->post_data, 'height_l').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />'),
						'original'	 => array('url' => $this->get_val($this->post_data, 'url_o'), 'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, 'url_o').'" width="'.$this->get_val($this->post_data, 'width_o').'" height="'.$this->get_val($this->post_data, 'height_o').'" alt="'.FA::esc_attr($this->get_val($this->post_data, 'title')).'" data-no-retina />')
					)
				);
			break;
			case 'youtube':
				...
				if(!empty($thumbs)){
					foreach($thumbs as $name => $vals){
						...
						switch($additions['yt_type']){
							case 'channel':
								$attr1['img_urls'][$name]['tag'] = '<img'.$class.' src="'.$this->get_val($vals, 'url').'" alt="'.FA::esc_attr($this->get_val($attr1, 'title')).'" data-no-retina />';
							break;
							case 'playlist':
								$attr1['img_urls'][$name]['tag'] = '<img'.$class.' src="'.$this->get_val($vals, 'url').'" width="'.$this->get_val($vals, 'width').'" height="'.$this->get_val($vals, 'height').'" alt="'.FA::esc_attr($this->get_val($attr1, 'title')).'" data-no-retina />';
							break;
						}
					}
				}
				...
				if(!empty($img_sizes)){
					foreach($img_sizes as $name => $vals){
						...
						$attr1['img_urls'][$name] = array(
							...
							'tag' => '<img'.$class.' src="'.$this->get_val($this->post_data, $name).'" alt="'.FA::esc_attr($this->get_val($attr1, 'title')).'" data-no-retina />'
						);
					}
				}
			break;
	...
	public function init_by_data($slide){
		...
		$this->params	 = (!is_array($this->params)) ? (array)FA::json_decode($this->params, true) : $this->params;
		$this->layers	 = ($this->init_layer) ? $this->layers = FA::json_decode($this->get_val($slide, 'layers'), true) : $this->get_val($slide, 'layers');
		$this->layers	 = (empty($this->layers)) ? array() : $this->layers;
		$this->settings	 = $this->get_val($slide, 'settings');
		$this->settings	 = (!is_array($this->settings)) ? (array)FA::json_decode($this->settings, true) : $this->settings;
		...
		if(!empty($slides)){
			...
			foreach($slides as $key => $slide){
				...
				if($this->get_val($slide, 'static', false) === true){
					$slides[$key]['title'] = __('Global Layers');
