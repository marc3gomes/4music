...
return [
    'modules' => [
        ...
        'Blueskytechco_AjaxSuite' => 1,
        'Blueskytechco_AskQuestion' => 1,
        'Blueskytechco_RokanBase' => 1,
        'Blueskytechco_CustomCatalog' => 1,
        'Blueskytechco_DailyDeal' => 1,
        'Blueskytechco_GroupedProduct' => 1,
        'Blueskytechco_Instagram' => 1,
        'Blueskytechco_LayeredAjax' => 1,
        'Blueskytechco_MenuBuilder' => 1,
        'Blueskytechco_OptimizeSpeed' => 1,
        'Blueskytechco_PageBuilderAdminModule' => 1,
        'Blueskytechco_PageBuilderCustom' => 1,
        'Blueskytechco_PriceCountdown' => 1,
        'Blueskytechco_ProductWidgetAdvanced' => 1,
        'Blueskytechco_QuickviewProduct' => 1,
        'Blueskytechco_CmsPageBanner' => 1,
        'Blueskytechco_SearchSuite' => 1,
        'Blueskytechco_SetProduct' => 1,
        'Blueskytechco_SizeChart' => 1,
        'Blueskytechco_StoreLocator' => 1,
        'Blueskytechco_Testimonial' => 1,
        'Blueskytechco_Themeoption' => 1,
        'Blueskytechco_WidgetCategory' => 1,
        'Frenet_Shipping' => 1,
        'Lof_EstimateShippingRate' => 0,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
