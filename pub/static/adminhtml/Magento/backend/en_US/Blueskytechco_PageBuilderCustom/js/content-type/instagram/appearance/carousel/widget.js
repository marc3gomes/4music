define([
    ...
    function initSlider($element) {
        var centerModeClass = 'center-mode',
            itemCount = $element.find('.elementor-instagram-item').length,
            carouselMode = $element.data('carousel-mode'),
            $carouselElement = $($element.children().find('.widget-instagram-slider')),
            slickConfig = {
    ...
    return function (config, element) {
        var $element = $(element);
        var $carouselElement = $($element.children().find('.widget-instagram-slider'));
        initSlider($element);
