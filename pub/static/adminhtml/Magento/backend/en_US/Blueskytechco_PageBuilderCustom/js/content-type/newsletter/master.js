...
define(["underscore", "Magento_PageBuilder/js/utils/object", "Magento_PageBuilder/js/content-type/appearance-config", "mage/url"], function (_underscore, _object, _appearanceConfig, _url) {
  /**
  ...
  var Master = /*#__PURE__*/function () {
    ...
    _proto.getActionNewsletter = function getActionNewsletter() {
      return window.CUSTOM_BASE_URL+'newsletter/subscriber/new';
    }
    /**
     * Attach event to updating data in data store to update observables
     */
