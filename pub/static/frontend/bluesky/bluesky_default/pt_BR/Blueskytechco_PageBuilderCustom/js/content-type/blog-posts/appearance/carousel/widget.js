define([
    ...
    function initSlider($element) {
        var centerModeClass = 'center-mode',
            itemCount = $element.find('.elementor-blog-post-item').length,
            carouselMode = $element.data('carousel-mode'),
            $carouselElement = $($element.children().find('.widget-blog-post-slider')),
            slickConfig = {
    ...
    return function (config, element) {
        var $element = $(element);
        var $carouselElement = $($element.children().find('.widget-blog-post-slider'));
        initSlider($element);
