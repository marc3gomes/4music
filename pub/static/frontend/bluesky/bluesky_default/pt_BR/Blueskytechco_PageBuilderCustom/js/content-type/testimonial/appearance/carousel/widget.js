define([
    ...
    function initSlider($element) {
        var centerModeClass = 'center-mode',
            itemCount = $element.find('.elementor-testimonial-item').length,
            carouselMode = $element.data('carousel-mode'),
            $carouselElement = $($element.children().find('.widget-testimonial-slider')),
            slickConfig = {
    ...
    return function (config, element) {
        var $element = $(element);
        var $carouselElement = $($element.children().find('.widget-testimonial-slider'));
        initSlider($element);
